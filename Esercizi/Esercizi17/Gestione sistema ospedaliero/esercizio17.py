...
- La classe Persona deve avere i seguenti metodi:
    ...
    impostare a None l'attributo che non risulta essere una stringa, stampando un messaggio di errore, ad esempio, "Il nome inserito non è una stringa!". 
...
- Definire i seguenti metodi:
    ...
    identificativo del paziente da rimuovere, aggiornando poi il numero di fatture e il salario, richiamando il metodo get Fatture() e getSalary(). 
